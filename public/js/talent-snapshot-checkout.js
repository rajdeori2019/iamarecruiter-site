(function () {
  ...
  function ensureModal() {
    ...
    style.textContent =
      ...
      '.tms-pay-btn{width:100%;margin-top:16px}' +
      '.tms-secure{margin-top:9px;font-family:var(--font-mono,monospace);font-size:10px;color:var(--text-muted,#666);text-transform:uppercase;letter-spacing:.05em;text-align:center}' +
    ...
    modal.innerHTML =
      ...
      '</div>' +
      '<div class="tms-summary"><div class="tms-summary-row"><span>Price</span><strong>₹99</strong></div><div class="tms-summary-row"><span>Discount</span><strong id="tmsDiscount">₹0</strong></div><div class="tms-summary-row total"><span>Total</span><strong id="tmsTotal">₹99</strong></div></div>' +
      '<div id="tmsCheckoutError" class="tms-checkout-error"></div>' +
      '<button id="tmsPayButton" class="btn btn--accent tms-pay-btn" type="submit">Continue to Secure Payment — ₹99</button>' +
      '<div class="tms-secure">Payment processed securely by Razorpay</div>' +
      '</form></div>';
